...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { correct_answer: @option.correct_answer, option_text: @option.option_text, question_id: @option.question_id }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { correct_answer: @option.correct_answer, option_text: @option.option_text, question_id: @option.question_id }
    assert_redirected_to option_path(assigns(:option))
  end
